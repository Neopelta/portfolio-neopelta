...
<main class="container">
	<nav class="breadcrumb">
		<a href="/{currentLang}">{$_('project_page.home')}</a>
	...
	<section class="project-content">
		...
		{:else}
			<div class="content-placeholder">
				...
				<p>{$_('project_page.coming_soon_features')}</p>
				<ul>
					<li>{$_('project_page.coming_soon_screenshots')}</li>
					<li>{$_('project_page.coming_soon_features_explanation')}</li>
					<li>{$_('project_page.coming_soon_challenges')}</li>
					<li>{$_('project_page.coming_soon_learnings')}</li>
					<li>{$_('project_page.coming_soon_code')}</li>
					<li>{$_('project_page.coming_soon_sources')}</li>
					<li>{$_('project_page.coming_soon_downloads')}</li>
				</ul>
			</div>
		{/if}
	</section>
