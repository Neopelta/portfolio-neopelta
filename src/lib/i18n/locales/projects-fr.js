export const projects = [
	...
	},
	{
		...
		title: 'SkillTracker',
		description:
			'Application de suivi de compétences techniques avec tableau de bord personnalisable. Développé en React avec un backend Express.js, ce projet permet aux utilisateurs de suivre leur progression.',
		date: '2025',
		category: 'Web',
		featured: true,
		technologies: [
	...
	},
	{
		...
		description:
			"Station météorologique IoT basée sur STM32 avec capteurs environnementaux (température, humidité, pression). Communication dual filaire/Bluetooth Low Energy vers interface graphique Qt temps réel. Projet universitaire intégrant programmation embarquée, protocoles sans fil et développement d'IHM.",
		date: '2025',
		category: 'Embarqué',
		featured: false,
		technologies: [
	...
	},
	{
		...
		title: 'The Cave',
		description:
			"Jeu d'aventure textuel inspiré de Colossal Cave Adventure développé en Java. Le joueur incarne Dave, un héros piégé dans une caverne mystérieuse dont personne n'est jamais revenu vivant. Système de combat tactique, gestion d'inventaire, marchands dynamiques et événements aléatoires.",
		date: '2023',
		category: 'Jeu/3D',
		featured: false,
	...
	},
	{
		...
		title: 'Tetris',
		description:
			"Jeu Tetris complet développé en OCaml dans le cadre d'un projet étudiant en binôme. Implémentation des 7 formes classiques avec rotations authentiques, système de lignes complètes, score progressif et écran Game Over. Utilise la bibliothèque Graphics d'OCaml pour l'interface graphique.",
		date: '2022',
		category: 'Jeu/3D',
		featured: false,
